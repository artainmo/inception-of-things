...
argocd app create will --repo 'https://gitlab.com/artainmo/inception-of-things.git' --path 'p3/app/app' --dest-namespace 'dev' --dest-server 'https://kubernetes.default.svc' --grpc-web
